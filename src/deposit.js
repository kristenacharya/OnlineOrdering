...
function Deposit(){
    ...
    function handleDeposit(){
      ...
      ctx.users.push({name:ctx.users[newestUser].name, email:ctx.users[newestUser].email, password:ctx.users[newestUser].password, balance:newBalance,transaction:'Deposit',amount:amount});
      setShow(false);
    }    
