...
function Withdraw(){
    ...
    function handleWithdraw(){
      ...
      ctx.users.push({name:ctx.users[newestUser].name, email:ctx.users[newestUser].email, password:ctx.users[newestUser].password, balance:newBalance,transaction:'Withdrawal',amount:amount});
      setShow(false);
    }    
